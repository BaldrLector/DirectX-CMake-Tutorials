...
void CD3DSettingsDlg::CreateControls()
{
    ...
    m_Dialog.SetFont( 0, (WCHAR *)L"Arial", 15, FW_NORMAL );
    m_Dialog.SetFont( 1, (WCHAR *)L"Arial", 28, FW_BOLD );
    ...
    if( pElement )
    {
        ...
        m_Dialog.AddStatic( DXUTSETTINGSDLG_STATIC, (WCHAR *)L"Direct3D Settings", 10, 5, 400, 50, false, &pStatic );
    ...
    m_Dialog.AddStatic( DXUTSETTINGSDLG_D3D11_FEATURE_LEVEL_LABEL, (WCHAR *)L"Feature Level", 10, 60, 180, 23 );
    ...
    m_Dialog.AddStatic( DXUTSETTINGSDLG_STATIC, (LPCWSTR)L"Display Adapter", 10, 85, 180, 23 );
...
WCHAR* DXUTAPIVersionToString( DXUTDeviceVersion version )
{
    ...
    {
        case DXUT_D3D9_DEVICE:
            return (WCHAR *)L"Direct3D 9";
		case DXUT_D3D11_DEVICE:
			return (WCHAR *)L"Direct3D 11";
        default:
            return (WCHAR *)L"Unknown version";
    }
}
...
WCHAR* DXUTD3DDeviceTypeToString( D3DDEVTYPE devType )
{
    ...
    {
        case D3DDEVTYPE_HAL:
            return (WCHAR *)L"D3DDEVTYPE_HAL";
        case D3DDEVTYPE_SW:
            return (WCHAR *)L"D3DDEVTYPE_SW";
        case D3DDEVTYPE_REF:
            return (WCHAR *)L"D3DDEVTYPE_REF";
        default:
            return (WCHAR *)L"Unknown devType";
    }
}
...
WCHAR* DXUTD3DX11DeviceTypeToString( D3D_DRIVER_TYPE devType )
{
    switch( devType )
    {
        case D3D_DRIVER_TYPE_HARDWARE:
            return (WCHAR *)L"D3D_DRIVER_TYPE_HARDWARE";
        case D3D_DRIVER_TYPE_REFERENCE:
            return (WCHAR *)L"D3D_DRIVER_TYPE_REFERENCE";
        case D3D_DRIVER_TYPE_NULL:
            return (WCHAR *)L"D3D_DRIVER_TYPE_NULL";
        case D3D_DRIVER_TYPE_WARP:
            return (WCHAR *)L"D3D_DRIVER_TYPE_WARP";
        default:
            return (WCHAR *)L"Unknown devType";
    }
}
...
WCHAR* DXUTMultisampleTypeToString( D3DMULTISAMPLE_TYPE MultiSampleType )
{
    switch( MultiSampleType )
    {
        case D3DMULTISAMPLE_NONE:
            return (WCHAR *)L"D3DMULTISAMPLE_NONE";
        case D3DMULTISAMPLE_NONMASKABLE:
            return (WCHAR *)L"D3DMULTISAMPLE_NONMASKABLE";
        case D3DMULTISAMPLE_2_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_2_SAMPLES";
        case D3DMULTISAMPLE_3_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_3_SAMPLES";
        case D3DMULTISAMPLE_4_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_4_SAMPLES";
        case D3DMULTISAMPLE_5_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_5_SAMPLES";
        case D3DMULTISAMPLE_6_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_6_SAMPLES";
        case D3DMULTISAMPLE_7_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_7_SAMPLES";
        case D3DMULTISAMPLE_8_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_8_SAMPLES";
        case D3DMULTISAMPLE_9_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_9_SAMPLES";
        case D3DMULTISAMPLE_10_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_10_SAMPLES";
        case D3DMULTISAMPLE_11_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_11_SAMPLES";
        case D3DMULTISAMPLE_12_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_12_SAMPLES";
        case D3DMULTISAMPLE_13_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_13_SAMPLES";
        case D3DMULTISAMPLE_14_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_14_SAMPLES";
        case D3DMULTISAMPLE_15_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_15_SAMPLES";
        case D3DMULTISAMPLE_16_SAMPLES:
            return (WCHAR *)L"D3DMULTISAMPLE_16_SAMPLES";
        default:
            return (WCHAR *)L"Unknown Multisample Type";
    }
}
...
WCHAR* DXUTVertexProcessingTypeToString( DWORD vpt )
{
    switch( vpt )
    {
        case D3DCREATE_SOFTWARE_VERTEXPROCESSING:
            return (WCHAR *)L"Software vertex processing";
        case D3DCREATE_MIXED_VERTEXPROCESSING:
            return (WCHAR *)L"Mixed vertex processing";
        case D3DCREATE_HARDWARE_VERTEXPROCESSING:
            return (WCHAR *)L"Hardware vertex processing";
        case D3DCREATE_PUREDEVICE:
            return (WCHAR *)L"Pure hardware vertex processing";
        default:
            return (WCHAR *)L"Unknown vertex processing type";
    }
}
...
WCHAR* DXUTPresentIntervalToString( UINT pi )
{
    switch( pi )
    {
        case D3DPRESENT_INTERVAL_IMMEDIATE:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_IMMEDIATE";
        case D3DPRESENT_INTERVAL_DEFAULT:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_DEFAULT";
        case D3DPRESENT_INTERVAL_ONE:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_ONE";
        case D3DPRESENT_INTERVAL_TWO:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_TWO";
        case D3DPRESENT_INTERVAL_THREE:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_THREE";
        case D3DPRESENT_INTERVAL_FOUR:
            return (WCHAR *)L"D3DPRESENT_INTERVAL_FOUR";
        default:
            return (WCHAR *)L"Unknown PresentInterval";
    }
}
